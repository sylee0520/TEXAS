...
TEXAS is the framework that summarizes your own textbook data and generates the question & answer set based summarized text.
In most textbooks, information is spread widely and there are not many questions provided and in addition, not all existing questions have answers. So we released the <b>TEXAS</b> for relieving this problems. We also provide data summarizing open-source computer science textbooks as TEXAS and a set of questions and answers created using them. Use TEXAS to get an A+ this semester!
